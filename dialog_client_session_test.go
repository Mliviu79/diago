...
func TestIntegrationDialogClient(t *testing.T) {
	...
	t.Run("HanguperClientWithServe", func(t *testing.T) {
		...
		err := serveBackground(t, phone, t.Context(), func(d *DialogServerSession) {})
		require.NoError(t, err)
...
func TestIntegrationDialogClientCancel(t *testing.T) {
	...
	serveBackground(t, dg, ctx, func(d *DialogServerSession) {
		ctx := d.Context()
		d.Trying()
		d.Ringing()
...

	{
		...
		dg := newDialer(ua)
		serveBackground(t, dg, t.Context(), func(d *DialogServerSession) {})
